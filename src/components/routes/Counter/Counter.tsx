...
import { incremented, asyncDelta, decremented, arbitraryDelta, randomShift } from "store/reducers/counter/counter"
...
const Counter = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => dispatch(asyncDelta(getRandomNumberInModule(20)))}> async saga ? </button>
